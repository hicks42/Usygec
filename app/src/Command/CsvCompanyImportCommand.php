...
class CsvCompanyImportCommand extends Command
{
    protected static $defaultName = 'app:company-from-csv';

    protected static $defaultDescription = 'Importe les info de sociétés';
