...
namespace App\Entity\EntityMC;

use App\Classe\Search;
use App\Entity\EntityMC\Categorie;
use App\Entity\EntityMC\Performance;
use App\Entity\EntityMC\RepartSector;
use App\Entity\EntityMC\RepartGeo;
